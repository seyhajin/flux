...
class Project:
    ...
    def gen_ninja(self, file, build_opts, target):
        ...
        n.variable('cc_opts_target', util.replace_env(target.opts['cc'], os.environ))
        n.variable('cxx_opts_target',util.replace_env(target.opts['cxx'], os.environ))
        n.variable('as_opts_target', util.replace_env(target.opts['as'], os.environ))
        n.variable('ar_opts_target', util.replace_env(target.opts['ar'], os.environ))
        n.variable('ld_opts_target', util.replace_env(target.opts['ld'], os.environ))
        n.newline()
